                ...
                <div class="overflow-auto bg-white">
                  ...
                  if(isset($_POST['check'])){
                    if(isset($_POST['check_list'])){
                      ...
                      header("location:success-withdraw.php?msg=$msg");
                    }
                  }
                  ?>
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    $deposit =_query("SELECT * FROM withdraw WHERE status='Success' ORDER BY id DESC LIMIT $offset, $total_records_per_page");
                    $total_records = mysqli_num_rows(_get("withdraw","status='Success'")); 
                    ...
                    ?>
                      <tr class="hover:bg-gray-100">
                        ...
                        <td class="text-center p-4 space-x-2 whitespace-nowrap lg:p-5">
                          <a href="delete.php?src=success-withdraw&&table=withdraw&&id=<?php echo $data['id']?>" class="popup_show btn bg-red-500 w-fit text-white">Delete</a>                          
                        </td>
                      </tr>
                      <?php }?>
