            ...
            <div class="inline-block min-w-full align-middle">
                <div class="overflow-auto bg-white">
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    $deposit =_query("SELECT * FROM withdraw WHERE status='Pending' ORDER BY id DESC LIMIT $offset, $total_records_per_page");
                    $total_records = mysqli_num_rows(_get("withdraw","status='Pending'")); 
                    ...
                    ?>
                      <tr class="hover:bg-gray-100">
                        ...
                        <td class="text-center p-4 space-x-2 whitespace-nowrap lg:p-5">
                          <a id="add_bank" href="approve-withdraw.php?src=pending-withdraw&&table=withdraw&&id=<?php echo $data['id']?>" class="popup_show btn bg-red-500 w-fit text-white" style="background:#4ade80;">Approve</a>
                          <a href="delete.php?src=pending-withdraw&&table=withdraw&&id=<?php echo $data['id']?>" class="popup_show btn bg-red-500 w-fit text-white">Delete</a>                          
                        </td>
                      </tr>
                      <?php }?>
